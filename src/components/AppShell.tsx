...
function DeviceIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="5" y="2.5" width="14" height="19" rx="2" stroke="currentColor" strokeWidth="2" /></svg>;
}
...
function ConfigIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M17.5 6.5l-2.8 2.8M9.3 14.7l-2.8 2.8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" opacity=".45" />
    </svg>
  );
}
        ...
        <aside className="sidebar">
          <div className="sidebar-inner">
            ...
            <nav className="sidebar-nav">
              ...
              <NavLink to="/configurations" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
                <ConfigIcon />
