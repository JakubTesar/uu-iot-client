import type { DeviceMessage } from '../../types/api';
...
export function ConfigurationMessages({ messages, isLoading, deviceId, onDeviceIdChange, onLoad }: ConfigurationMessagesProps) {
  return (
    <div className="panel chat-card">
      <div className="panel-body">
        ...
        <div className="chat-history">
          ...
          {messages.length === 0 && <div className="text-muted">No messages loaded for this configuration.</div>}
        </div>
      </div>
    </div>
  );
