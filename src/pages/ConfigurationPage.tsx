    ...
    <>
      ...
      <div className="content-grid config-grid">
        ...
        <div className="stack">
          ...
          <ConfigurationMessages messages={configurations.selectedConfigurationMessages} isLoading={configurations.isMessagesLoading} deviceId={messageDeviceId} onDeviceIdChange={setMessageDeviceId} onLoad={() => void action.run(() => configurations.loadMessagesForDevice(messageDeviceId))} />
        </div>
      </div>
    </>
  );
